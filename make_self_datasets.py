...
path_1 = "E:\zero_shot\GT2\GTnet-master1 (1)\FSC\Aluminum"
save_path = 'E:\zero_shot\GT2\GTnet-master1 (1)\FSC\\train.txt'
file = open(save_path, 'w')
images_file = open('E:\zero_shot\GT2\GTnet-master1 (1)\FSC\\trian.txt', 'w')
images_classes_file = open('E:\zero_shot\GT2\GTnet-master1 (1)\FSC\\train.txt', 'w')
a = 0
